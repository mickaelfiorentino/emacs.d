...
** Defaults
#+BEGIN_SRC emacs-lisp
  (setq my-bibliography-directory  "~/Projects/research/bibliography")
  (setq my-bibliography-file       (expand-file-name "bibliography.bib" my-bibliography-directory))
  (setq my-bibliography-notes      (expand-file-name "bibliography.org" my-bibliography-directory))
  (setq my-bibliography-pdfs       (expand-file-name "files/" my-bibliography-directory))
  ;; (message (format "Bibliography file: %s" my-bibliography-file))
#+END_SRC
...
(use-package ivy-bibtex
  ...
  (setq ivy-re-builders-alist
      '((ivy-bibtex . ivy--regex-ignore-order)
        (t . ivy--regex-plus)))
  :init
  (setq bibtex-completion-bibliography "~/Projects/research/bibliography/bibliography.bib")
  (setq bibtex-completion-notes-path   "~/Projects/research/bibliography/bibliography.org")
  (setq bibtex-completion-library-path "~/Projects/research/bibliography/files/")
...
#+BEGIN_SRC emacs-lisp
  (use-package org-ref
    :after org
    :init
    (setq org-ref-default-bibliography '("~/Projects/research/bibliography/bibliography.bib"))
    (setq org-ref-bibliography-notes   "~/Projects/research/bibliography/bibliography.org")
    (setq org-ref-pdf-directory        "~/Projects/research/bibliography/files/")  
    ;; Use ivy
