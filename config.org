  ...
  (when (display-graphic-p)
   (use-package smart-mode-line
    ...
    :config
     ...
     (setq sml/theme 'my-light) ;; automatic light dark respectful
...
#+BEGIN_SRC emacs-lisp
  (use-package ebib
   :ensure t
   :config (setq ebib-bib-search-dirs '("~/Projects/research/"))
           (setq ebib-preload-bib-files '("~/Projects/research/Library.bib"))
           (setq ebib-notes-use-single-file "~/Projects/research/Library.org")
