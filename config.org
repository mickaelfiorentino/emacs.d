...
- Configuration
#+BEGIN_SRC emacs-lisp
(setq user-bibliography-directory    "~/Project/research/bibliography")
(setq bibtex-completion-bibliography (expand-file-name "bibliography.bib" user-bibliography-directory))
(setq bibtex-completion-notes-path   (expand-file-name "bibliography.org" user-bibliography-directory))
(setq bibtex-completion-library-path (expand-file-name "files" user-bibliography-directory))
